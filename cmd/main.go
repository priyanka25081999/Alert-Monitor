...
func addAlertConfigHandler(w http.ResponseWriter, r *http.Request) {
	...
	// send response: Sends a JSON response confirming the configuration was added successfully, along with the Client and EventType from the config.
...
func recordEventHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Response: Sends a JSON response indicating the event was recorded, along with Client, EventType, and alert information.
